...
<div class="mobile-menu mobile-menu--dashboard md:hidden">
    <div class="mobile-menu-bar">
        ...
        <a href="javascript:;" id="mobile-menu-toggler"> <i data-feather="bar-chart-2"
                                                            class="w-8 h-8 text-gray-600 dark:text-white transform -rotate-90"></i>
        </a>
    </div>
...
<div class="flex overflow-hidden">
    ...
    <!-- END: Side Menu -->
    <!-- BEGIN: Content -->
    <div class="content {% if contnetClass is defined %}{{ contentClass }}{% endif %}">
        <!-- BEGIN: Top Bar -->
        <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
            ...
            <div class="intro-x dropdown w-8 h-8">
                <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in"
                    ...
                    <img alt="Tinker Tailwind HTML Admin Template" src="/images/profile-15.jpg">
                </div>
