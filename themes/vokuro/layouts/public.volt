        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <form action="/session/login"
                ...
                <div class="intro-x mt-8">
                    ...
                    {# placeholder="Email"> #}
                    {{ form.render('email', ['class': 'intro-x login__input form-control py-3 px-4 border-gray-300 block', 'placeholder': 'Email']) }}
                    {{ form.render('password', ['class': 'intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4', 'placeholder': 'Password']) }}
                ...
                <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                    <div class="flex items-center mr-auto">
                        ...
                        {{ form.render('remember', ['class': 'form-check-input border mr-2','id' : 'remember-me']) }}
                        <label class="cursor-pointer select-none" for="remember-me">Remember me</label>
                    </div>
                    <a href="">Forgot Password?</a>
                </div>
                <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                    {{ form.render('Login',['class': 'btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top']) }}
                    {# <button class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Login</button> #}
                    <button class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Sign up
                    </button>
                </div>
